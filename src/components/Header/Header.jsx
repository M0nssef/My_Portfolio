          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-[10px]">
              ...
              <div className="leading-[20px]">
                <h2 className='text-xl text-smallTextColor font-[700]'>Fatih</h2>
            ...
            <div className="flex items-center gap-4"> 
              ...
              <a href="https://www.linkedin.com/in/fatih-monssef-864104264/" target='_blank' rel="noreferrer">Let's Talk
              </a>
              </button>
